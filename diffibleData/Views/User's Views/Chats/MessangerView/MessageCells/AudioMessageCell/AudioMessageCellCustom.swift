...
open class AudioMessageCellCustom: AudioMessageCell {
    ...
    open override func configure(with message: MessageType, at indexPath: IndexPath, and messagesCollectionView: MessagesCollectionView) {
        ...
        if messagesCollectionView.messagesDataSource!.isFromCurrentSender(message: mock) {
            ...
            messageInfoViewSended.dateLabel.textColor = displayDelegate.audioTintColor(for: mock, at: indexPath, in: messagesCollectionView)
            messageInfoViewSended.sendStatusImageView.tintColor = displayDelegate.audioTintColor(for: mock, at: indexPath, in: messagesCollectionView)
            ...
            messageInfoViewRecieved.dateLabel.textColor = displayDelegate.audioTintColor(for: mock, at: indexPath, in: messagesCollectionView)
